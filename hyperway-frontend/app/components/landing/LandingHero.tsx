        ...
        <div className="border-2 border-white mx-6 my-3 p-3 rounded-2xl">
          ...
          <div className="text-center max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
            ...
            <p className="leading-relaxed text-sm sm:text-lg text-white/60 max-w-2xl mt-8 mx-auto px-4">
              Access affordable AI compute power or monetize your idle GPUs —
              all secured by smart contracts on Polkadot Hub. No intermediaries.
              No censorship. Just trustless execution at 70% lower cost than
              AWS.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10 mb-16">
              ...
              <Link href="/provider-dashboard">
                <button className="group cursor-pointer text-sm sm:text-base font-semibold text-white/80 bg-white/5 border border-white/10 rounded-md py-4 px-10 transition-all duration-300 hover:bg-white/10 hover:text-white">
                  Become a Provider
                </button>
              </Link>
            </div>
