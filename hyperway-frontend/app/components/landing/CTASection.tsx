...
export default function CTASection() {
  return (
    <section className="mt-12 sm:mt-16 md:mt-32 mb-12 sm:mb-16 md:mb-24 px-4 sm:px-6 relative" id="cta">
        ...
        <div className="relative overflow-hidden rounded-3xl p-8 sm:p-12 md:p-16 bg-gradient-to-br from-violet-900/40 to-black border border-violet-500/30 text-center shadow-[0_0_50px_-12px_rgba(139,92,246,0.3)]">
          ...
          <div className="relative z-10">
            ...
            <p className="text-base sm:text-lg text-white/70 leading-relaxed max-w-2xl mx-auto mb-10">
              Join the fastest-growing decentralized compute marketplace on Polkadot. Access high-end GPUs instantly or start monetizing your idle hardware today.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/marketplace">
                <button className="group relative w-full sm:w-auto text-sm sm:text-base font-semibold text-black bg-white rounded-md py-4 px-10 transition-all duration-300 hover:bg-gray-200 hover:shadow-[0_0_20px_-5px_rgba(255,255,255,0.5)] overflow-hidden">
              ...
              <Link href="/provider-dashboard">
                <button className="group w-full sm:w-auto text-sm sm:text-base font-semibold text-white bg-white/10 border border-white/20 rounded-md py-4 px-10 transition-all duration-300 hover:bg-white/20 flex items-center justify-center gap-2">
